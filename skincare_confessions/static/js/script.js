...
/* Listens to change event on is_vegan boolean checkboxfield,
marks true when checked */
...
$("#rating-3").click(function () {
    $(".fa-star").css("color", "#cccccc");
    $("#rating-0, #rating-1, #rating-2, #rating-3").css(
        "color", "#ffd01f");
});
$("#rating-4").click(function () {
    $(".fa-star").css("color", "#cccccc");
    $("#rating-0, #rating-1, #rating-2, #rating-3, #rating-4").css(
        "color","#ffd01f");
});
